<template>
  <div class="wheel-date-range-picker" style="border: 1px solid red;" ref="wrapper">
    <w-popover ref="popover" position="bottom" :container="popoverContainer" @open="onOpen">
      ...
      <template slot="content">
        <div :class="c('pop')" @selectstart.prevent>
          <div :class="c('pickers')">
            <div :class="c('picker1')">
              <div class="wheel-date-range-picker-nav">
                <span :class="c('prevYear', 'navItem')" @click="onClickPrevYear">
                  <w-icon name="leftleft"/>
                </span>
                ...
                <span :class="c('nextYear', 'navItem')" @click="onClickNextYear">
                  <w-icon name="rightright"/>
                </span>
              </div>
              <div class="wheel-date-range-picker-panels">
                <div class="wheel-date-range-picker-content">
          ...
          <div class="wheel-date-range-picker-actions">
...
export default {
  components: { WInput, WIcon, WPopover, WButton },
  ...
  methods: {
    c(...classNames) {
      return classNames.map(className => `wheel-date-range-picker-${className}`);
    },
    onInput(value) {
