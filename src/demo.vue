<template>
  <div class="page" style="position:relative;">
    ...
    <w-scroll style="width: 300px; height: 400px;">
...
<script>
  import WScroll from './scroll/scroll'
  let array = [
  ...
  export default {
    ...
    mounted () {
      setTimeout(() => {
        ...
        img.src = 'https://developer.mozilla.org/static/browsers/samsunw-internet.8faa2ee1b8a1.svg'
        img.height = 1000
